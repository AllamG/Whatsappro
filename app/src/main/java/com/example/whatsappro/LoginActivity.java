...
public class LoginActivity extends AppCompatActivity {
    ...
    private PhoneAuthProvider.ForceResendingToken mResedingToken;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enviar_numero.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(phoneNumber)){
                    ...
                    loadingBar.setTitle("Enviando Codigo");
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(String verificationId,
                ...
                mResedingToken = token;
                loadingBar.dismiss();
                Toast.makeText(LoginActivity.this, "Codigo eniado revise su mensajeria", Toast.LENGTH_SHORT).show();
                numero.setVisibility(View.GONE);
                enviar_numero.setVisibility(View.GONE);
